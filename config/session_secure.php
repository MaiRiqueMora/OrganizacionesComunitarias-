...
class Logger {
    ...
    public function logErrorToDatabase($message, $userId = null, $context = '') {
        // Implementar logeo en base de datos
        // Ejemplo: INSERT INTO errors (message, user_id, context) VALUES (?, ?, ?)
        // Esto es un ejemplo, debe adaptarse a la estructura real de la base de datos
        echo "Error: $message\n";
    }
}
